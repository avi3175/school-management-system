...
import { createParentService, getAllParentsService, getSingleParentService, updateParentService, deleteParentService, } from "./parent.service.js";
// ➕ Create Parent
...
// 📄 Get Single Parent
export const getSingleParent = asyncHandler(async (req, res) => {
