...
export type TeacherOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "designation" | "department" | "phone" | "address" | "gender" | "dateOfBirth" | "createdAt" | "updatedAt", ExtArgs["result"]["teacher"]>;
